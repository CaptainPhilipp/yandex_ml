...
describe 'yandex example file spec' do
  ...
  specify do
    ...
    expect(offers[0].price.to_i).to eq(15000)
    ...
    expect(offers[1].price.to_i).to eq(100)
    ...
    expect(offers[2].price.to_i).to eq(200)
    ...
    expect(offers[3].price.to_i).to eq(450)
    ...
    expect(offers[4].price.to_i).to eq(400)
    ...
    expect(offers[5].price.to_i).to eq(30000)
    ...
    expect(offers[6].price.to_i).to eq(5000)
